...
Choose only 1 [protocol](protocols) according to the will, then run from top to bottom, never stops before the bottom. Bound by the [TAO](TAO). Attach TAO contents in every single call to the model
